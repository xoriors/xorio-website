...
function about(ctx) {
  ...
  <div class="about-section"><div class="about-section-label">friends — communities we build with</div>
    <div class="about-grid">
      <div class="about-card"><h2 class="about-card-title">Forge Baia Mare</h2><p class="about-card-desc">A free monthly meetup in Baia Mare for everyone who builds — developers, designers and makers alike. No speakers, no badges, no networking format: an open floor at BASE coworking where people pair up, bring the project they're stuck on and ship together. <em>Build together. Learn together. Ship together.</em> &nbsp;${lnk('https://forgebaiamare.ro/', 'forgebaiamare.ro ↗', true)}</p></div>
      <div class="about-card"><h2 class="about-card-title">*Tech-RD — Star Tech RD Reloaded</h2><p class="about-card-desc">A long-running Romanian tech community with regular talks on Rust, AI, DevOps, Flutter, algorithms and more — friends, beer, snacks and, most important, tech talks. Our own talks and coding challenges are announced through their events. &nbsp;${lnk('https://startech-rd.io/', 'startech-rd.io ↗', true)} &nbsp;${lnk('https://www.meetup.com/star-tech-rd-reloaded', 'Meetup ↗', true)}</p></div>
    </div>
  </div>
