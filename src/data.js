...
const PROJECTS = [
  ...
  {id:'oxfer',name:'Oxfer',kind:'app',cats:['fs','realtime'],shot:'oxfer',fit:'top',
   live:'https://oxfer.pages.dev/',repo:'https://github.com/radumarias/syncoxiders/tree/main/p2p-transfer',issues:'https://github.com/radumarias/syncoxiders/issues',tags:['e2ee','p2p'],tech:['Rust','WebAssembly','E2EE','WebRTC','iroh','BLAKE3'],
   blurb:'End-to-end encrypted, peer-to-peer file transfer in the browser — your files, their device, no cloud in between.',
   body:['Pick a file, share one private link, and the receiver pulls it straight from your browser. Oxfer goes peer-to-peer whenever the network allows: the two browsers open a direct WebRTC data channel, so your files never pass through a server. No accounts, no uploads, no cloud storage: your files exist only on the two devices.',
